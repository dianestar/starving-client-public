                ...
                <section className="w-full h-[45px] bg-cyan-400">
                    <article className="w-2/3 h-full mx-auto py-auto flex justify-between">
                        <section className="flex items-center">
                            <input className="w-[350px] h-[30px] rounded px-2 text-xs" type="text" placeholder="음식명, 재료명으로 검색해주세요."></input>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 relative right-8" fill="none" viewBox="0 0 24 24" stroke="gray" strokeWidth={2}>
